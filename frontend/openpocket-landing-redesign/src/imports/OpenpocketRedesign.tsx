import svgPaths from "./svg-nctvpxfped";
  ...
  return (
    <div className="h-[32px] relative shrink-0 w-[22.857px]" data-name="Logo Icon">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[33.65px] items-center justify-center left-[calc(50%-0.03px)] top-[calc(50%+0.03px)] w-[23.232px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "153.5" } as React.CSSProperties}>
...
function Hero() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[1280px]" data-name="hero">
      <Hero1 />
...
function Heading() {
  return (
    <div className="h-[28px] relative shrink-0 w-[130px]" data-name="Heading 3">
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[28px] left-0 not-italic text-[#ff8a00] text-[32px] top-0">Local Runtime</p>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="h-[28px] relative shrink-0 w-[130px]" data-name="Heading 3">
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[28px] left-0 not-italic text-[#ff8a00] text-[32px] top-0">Human + Agent</p>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[28px] relative shrink-0 w-[130px]" data-name="Heading 3">
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[28px] left-0 not-italic text-[#ff8a00] text-[32px] top-0">{`Auditable & Private`}</p>
    </div>
  );
}
...
function Social() {
  return (
    <div className="relative shrink-0 size-[40px]" data-name="social">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[40px] left-1/2 top-1/2 w-[71.68px]" data-name="social 1">
...
function Entertainment() {
  return (
    <div className="relative shrink-0 size-[40px]" data-name="entertainment">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[40px] left-1/2 top-1/2 w-[71.68px]" data-name="entertainment 1">
...
function AndMoreIcon() {
  return (
    <div className="overflow-clip relative shrink-0 size-[40px]" data-name="And More Icon">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[61.076px] items-center justify-center left-[calc(50%-1.47px)] top-[calc(50%+0.04px)] w-[91.068px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "1539.5" } as React.CSSProperties}>
...
function Description1() {
  return (
    <div className="bg-white content-stretch flex gap-[24px] items-center overflow-clip relative shrink-0 w-full" data-name="description">
      <LocalRuntime3 />
      <LocalRuntime4 />
      <LocalRuntime5 />
      <LocalRuntime6 />
...
export default function OpenpocketRedesign() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[120px] items-start px-[80px] py-[160px] relative size-full" data-name="openpocket_redesign">
      <Header />
      <Hero />
      <OneLiner />
      <OneLiner1 />
